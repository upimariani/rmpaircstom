...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Laporan Transaksi Konsumen</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card card-light">
                        ...
                        <div class="card-body">
                            <?php
                            echo form_open('Admin/cLaporan/lap_harian_transaksi') ?>
                            <div class="row">
                                <div class="col-sm-4">
                ...
                <div class="col-md-4">
                    <div class="card card-light">
                        ...
                        <div class="card-body">
                            <?php
                            echo form_open('Admin/cLaporan/lap_bulanan_transaksi') ?>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Bulan</label>
                ...
                <div class="col-md-4">
                    <div class="card card-light">
                        ...
                        <div class="card-body">
                            <?php
                            echo form_open('Admin/cLaporan/lap_tahunan_transaksi') ?>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Tahun</label>
