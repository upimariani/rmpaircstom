			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="card card-primary">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<form action="<?= base_url('Admin/cSupplier/createSupplier') ?>" method="POST" role="form">
							<div class="card-body">
								<div class="row">
									<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<input type="text" name="nama_toko" class="form-control" id="exampleInputEmail1" placeholder="Masukkan nama toko">
