            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-warning">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <?php echo form_open('Gudang/cTransaksiLangsung/add_to_cart'); ?>
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Produk</label>
                                <select id="produk_a" class="form-control" name="produk" required>
                                    <option value="">---Pilih Produk---</option>
                                    <?php
                                    foreach ($produk as $key => $value) {
                                    ?>
                                        <option data-nama="<?= $value->nama_produk ?>" data-harga="<?= $value->price_gudang ?>" data-stok="<?= $value->stok_gudang ?>" value="<?= $value->id_produk ?>"><?= $value->nama_produk ?></option>
                                    <?php
                                    }
                                    ?>
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <br>
                            <form action="<?= base_url('Gudang/cTransaksiLangsung/checkout') ?>" method="POST">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="<?= base_url('Gudang/cTransaksiLangsung/delete/' . $value['rowid']) ?>"><i class="fas fa-trash"></i></a></td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
