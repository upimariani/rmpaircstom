...
<head>
    ...
    <title>LOGIN KONSUMEN RMPAIRCSTOM</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="../../index2.html"><b>LOGIN</b>KONSUMEN RMPAIRCSTOM</a>
        </div>
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="<?= base_url('Konsumen/cAuth') ?>" method="post">
                ...
                <p class="mb-1">
                <p>Apakah Anda belum memiliki akun? <a href="<?= base_url('Konsumen/cAuth/register') ?>">Register disini!!!</a></p>
                </p>
